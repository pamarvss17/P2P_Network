...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    //Phase 3
    string downloaddirstr = "sample-data5/files/client" + to_string(clientid)+ "/Downloaded";
                    ...
                    while (filereceiving < cnt) {
                        if (sizesoffiles[filereceiving] == 0) {
                            ...
                            if (recvsize > 0) {
                                ...
                                string filepath  = "sample-data5/files/client" + to_string(clientid) + "/Downloaded/" + filestoask2[i][filereceiving];
                ...
                if (filerequestmsg > 0) {
                    if (bufferp3[0] != '0') {
                        ...
                        while (y < nooffilestosend) {
                            ...
                            x++;
                            temp = "sample-data5/files/client" + to_string(clientid) + "/" + temp;
    ...
    for (int i = 0; i < nooffilestosearch; i++)
    {
        ...
        {
            string path = "sample-data5/files/client"+ to_string(clientid) + "/Downloaded/" + filenamestosearch[i];
                    ...
                    while (filereceiving < cnt) {
                        if (sizesoffiles[filereceiving] == 0) {
                            ...
                            if (recvsize > 0) {
                                ...
                                int remainingdata = stoi(temp);
                                string filepath  = "sample-data5/files/client" + to_string(clientid) + "/Downloaded/" + filestoask2new[i][filereceiving];
                                FILE* filepathdesc = fopen(filepath.c_str(), "w");
                                int rb = 0;
                                while (remainingdata > 0) {
