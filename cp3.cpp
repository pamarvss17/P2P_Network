...
int main(int argc, char* argv[])
{
    ...
    */
    ...
    for (int i = 0; i < noofneighbour; i++) {
        ...
        for (int j = 0; j < nooffilestosearch; j++) {
            if (replyfromneighbours[i][j] == '1') {
                cout << "Found " << filesindirectory[j] << " at " << neighbourids[i] << endl;
            }
        }
    }
    ...
    int filessent[noofneighbour] = {0};
    int filesreceived[noofneighbour] = {0};

    int currentfilesending[noofneighbour] = {0};
    int currentfilereceiving[noofneighbour] = {0};

    int filesrequestsent[noofneighbour] = {0};
    int filesrequestreceived[noofneighbour] = {0};
    ...
    while (check(filessent, noofneighbour) || check(filesreceived, noofneighbour)) {
        for (int i = 0; i < noofneighbour; i++) {
            if (filesrequestsent[i] == 0) {
            ...
            if ((filesrequestreceived[i] == 0) ||(filesreceived[i] == 0)) {
